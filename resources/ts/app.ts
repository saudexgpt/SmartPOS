...
const nsManageStores                 =   defineAsyncComponent( () => import( './pages/dashboard/stores/ns-manage-stores.vue' ) );
const nsStores                 =   defineAsyncComponent( () => import( './pages/dashboard/stores/ns-stores.vue' ) );
